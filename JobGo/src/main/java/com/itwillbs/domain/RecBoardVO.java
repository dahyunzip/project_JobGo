...
public class RecBoardVO {
	...
	private int topctg_id;                 // 직종 대분류 ㅇ
	private int btmctg_id;                 // 직종 소분류 ㅇ
	private int toplct_id;                 // 지역 대분류 ㅇ
	private int rec_viewcnt;               // 게시글 조회수
	
	private String rec_title;              // 채용 공고 제목 ㅇ
 	private String rec_maintask;           // 주요 업무      ㅇ
	private String rec_preference;         // 채용 우대 사항 ㅇ 
	private String rec_benefit;            // 복리 후생       ㅇ
	private String rec_inputlct;           // 상세 주소 입력  ㅇ
	private String rec_qualification;      // 입사 자격 요건  ㅇ
	private String thumbFileName;          // 썸네일 사진     ㅇ
	private String attachFileName;         // 첨부 파일/사진  ㅇ
	
	private Date rec_deadline;             // 채용 마감일     ㅇ
